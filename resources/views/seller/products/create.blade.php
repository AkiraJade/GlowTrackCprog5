...
@section('title', 'Add New Product - Seller Dashboard - GlowTrack')
                ...
                <div class="flex items-center justify-between gap-6">
                    <div>
                        ...
                        <p class="text-lg text-soft-brown opacity-75">
                            List your skincare product for sale
                        </p>
                    </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="description" 
                                  ...
                                  rows="4"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-jade-green focus:border-transparent transition"
                                  placeholder="Describe your product, its benefits, and key features...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div id="ingredients-container" class="space-y-3">
                        <div class="ingredient-input-group flex gap-3">
                            <input type="text" 
                                   ...
                                   value="{{ old('active_ingredients.0') ?? '' }}">
                            <button type="button" 
