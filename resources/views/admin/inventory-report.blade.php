...
<div class="min-h-screen bg-gradient-to-br from-mint-cream via-pastel-green to-light-sage py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex items-center justify-between">
            <div>
                <h1 class="text-4xl font-bold text-soft-brown font-playfair">Inventory Report</h1>
                <p class="text-soft-brown opacity-75 mt-2">Stock levels and inventory management insights</p>
            </div>
