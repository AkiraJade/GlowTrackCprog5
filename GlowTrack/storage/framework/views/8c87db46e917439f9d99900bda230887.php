<?php $__env->startSection('title', 'GlowTrack - Premium Skincare E-Commerce'); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-8">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="<?php echo e(route('register')); ?>" class="px-8 py-4 bg-jade-green text-white rounded-full font-semibold hover:shadow-lg hover:scale-105 transition transform text-center">
                        Get Started
                    </a>
...
<section class="py-20 bg-gradient-to-r from-jade-green to-light-sage text-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?php echo e(route('register')); ?>" class="px-8 py-4 bg-white text-jade-green rounded-full font-semibold hover:shadow-lg transition">
                Create Account
            </a>
            <a href="<?php echo e(route('login')); ?>" class="px-8 py-4 border-2 border-white text-white rounded-full font-semibold hover:bg-white hover:text-jade-green transition">
                Sign In
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sedriel Navasca\Desktop\COMPROG\GlowTrackCprog5\GlowTrack\resources\views/index.blade.php ENDPATH**/ ?>